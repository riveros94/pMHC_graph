...
if args.association_mode == 'identity':
    ...
    message_passing_molA = graph_message_passing(s_g1, 'resources/atchley_aa.csv', use_degree=False, norm_features=False)
    message_passing_molB = graph_message_passing(s_g2, 'resources/atchley_aa.csv', use_degree=False, norm_features=False)
